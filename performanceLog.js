...
// Web3 setup
const web3 = new Web3(new Web3.providers.HttpProvider('http://127.0.0.1:9545')); // Change to your Ethereum node URL
const contractAddress = '0xaECE3630275e08E02372B9beCd8C39a60710183A'; // Replace with your deployed contract address
const contractABI = [
  {
    "anonymous": false,
    "inputs": [
...
app.post('/notification', async (req, res) => {
    ...
    const filePath = '/YOUR-PATH/notificationData.json';
    fs.writeFile(filePath, JSON.stringify(notificationData, null, 2), async (err) => {
        ...
        try {
            ...
            const receipt = await notificationStorage.methods.storeNotification('title', notificationData.toString(), 'timestamp', 'sender')
